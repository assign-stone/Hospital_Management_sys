...
public class AppointmentModel {
	...
	private String physicianName;  // Add this field to store physician's name
    private String physicianSpecialty; // Add this field for physician's specialty
...
public class AppointmentModel {
    ...
    public AppointmentModel(int id, LocalDate date, LocalTime time, String disease, String appStatus,
                            int physician_id, int nurse_id, int patient_id) {
        this.id = id;
        this.date = date;
        this.time = time;
